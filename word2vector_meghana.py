...
Objectives:
1. Train Word2Vec (CBOW by default; Skip-Gram optional) on the given context.

2. Compute cosine similarity for the existing pairs:
    students vs learners
    projects vs assignments
    mentors vs teachers

3. Create a small dataset (5 docs) and convert each document to a vector (mean of word vectors).
"""
